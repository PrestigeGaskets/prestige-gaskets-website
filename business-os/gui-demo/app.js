...
(() => {
  ...
  function renderShipment() {
    ...
    form.innerHTML = `
      ...
      ${detail}
      <p class="note">Linking keys: <span class="mono">shipmentId=${ship.shipmentId}</span>${ship.deliveryNoteNo ? ` · <span class="mono">DN=${ship.deliveryNoteNo}</span>` : ""} · lines.orderNo → Sales Order · lines.sku → Product · Post / Unpost DN with toolbar Undo while staged</p>`;
  ...
  function boot() {
    ...
    document.getElementById("app").addEventListener("click", (e) => {
      ...
      if (action === "email-shipment") return toast("Email Delivery Note scaffold.");
