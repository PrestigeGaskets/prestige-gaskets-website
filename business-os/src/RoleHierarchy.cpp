...
RoleHierarchy::RoleHierarchy() {
    roles_ = {
        ...
        {"Sales",
         {"Viewer"},
         "Own customers, quotes, sales orders, and customer shipment fields.",
         {"customers.name", "customers.email", "customers.postcode", "customers.status",
          ...
          "orders.quoteNo", "orders.value", "orderLines.qty", "orderLines.price",
          "orderLines.sku", "products.sell", "products.description", "shipments.status",
          "shipments.customerId", "shipments.shipDate", "shipments.shipOrganisation",
          "shipments.shipLocation", "shipments.shippingContact", "shipments.arContact",
          ...
          "shipments.standardMessage", "shipmentLines.sku", "shipmentLines.deliveryQty",
          "shipmentLines.qtyShipped", "shipmentLines.orderNo"},
        ...
        {"Shipping",
         {"Viewer"},
         "Own customer shipments and shipment lines against sales orders.",
         {"shipments.status", "shipments.customerId", "shipments.shipDate", "shipments.currency",
          ...
          "shipments.shipLocation", "shipmentLines.sku", "shipmentLines.deliveryQty",
          "shipmentLines.qtyShipped", "shipmentLines.orderNo", "shipmentLines.warehouseBin"},
