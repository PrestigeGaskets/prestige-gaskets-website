...
RoleHierarchy::RoleHierarchy() {
    roles_ = {
        ...
        {"Sales",
         {"Viewer"},
         "Contacts, quotes & sales orders; confirm quotes (14-day) → SO ready-to-print; collect/via white-label. No Inventory / Raise PO / Despatch.",
         {"customers.name", "customers.email", "customers.postcode", "customers.status",
          ...
          "orderLines.sku", "custom.*"},
         {"customers", "quotes", "quoteLines", "orders", "orderLines", "customFields"}},
        {"Inventory",
         {"Viewer"},
